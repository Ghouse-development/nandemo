...
-- 確認クエリ
-- =====================================================
SELECT '設計士数：' AS label, COUNT(*) AS count FROM designers
UNION ALL
SELECT 'テンプレート数：', COUNT(*) FROM email_templates
UNION ALL
SELECT '業者数：', COUNT(*) FROM template_vendors
UNION ALL
SELECT 'タスクマッピング数：', COUNT(*) FROM task_template_mappings;
